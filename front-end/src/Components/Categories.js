          ...
          <ul>
              {
                categories.map(
                  ...
                  <li key={category.name}> 
                    <Link to={`/category/${category.name}`}>{ this.props.pagination.category === category.name || category.sub_categories.some(sub=>sub.name === this.props.pagination.category) ? <b>{category.name}</b> : category.name}</Link> 
